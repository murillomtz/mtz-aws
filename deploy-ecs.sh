...
# Script de Deploy ECS - Projeto MTZ
# Autor: Amazon Q
# Versão: 1.0.0
# 
...
DEFAULT_ECR_REPO="mtz"
DEFAULT_CLUSTER="cluster-mtz"
DEFAULT_SERVICE="service-mtz"
DEFAULT_TASK_FAMILY="task-def-mtz"
...
build_image() {
    ...
    docker build -t mtz-app:$tag -t mtz-app:latest -t $ecr_uri:$tag -t $ecr_uri:latest .
